  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/intelligentPaper', //智能组卷
          component: () => import('@/components/teacher/intelligentPaper')
        },
        {
        ...
        {
          path: '/examRoomManage',
          component: () => import('@/components/admin/examRoomManage')
        },
        {
          path: '/examArrangeManage',
          component: () => import('@/components/admin/examArrangeManage')
        }
      ]
    },
    {
