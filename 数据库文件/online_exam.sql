...
) ENGINE = InnoDB AUTO_INCREMENT = 20230028 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `score`  (
  ...
  `ptScore` int(11) NULL DEFAULT NULL COMMENT '是否及格，0不及格，1及格',
  `etScore` int(11) NULL DEFAULT NULL COMMENT '成绩',
  `score` int(11) NULL DEFAULT NULL COMMENT '试卷满分',
  `answerDate` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '答题日期',
  PRIMARY KEY (`scoreId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `score` VALUES (155, 20230002, 20224084, '数据库理论', 0, 0, 0, '2024-05-20');
INSERT INTO `score` VALUES (156, 20230001, 20224084, '计算机网络', 0, 6, 86, '2024-05-20');
INSERT INTO `score` VALUES (157, 20230001, 20224084, '计算机网络', 0, 4, 86, '2024-05-20');
INSERT INTO `score` VALUES (158, 20230001, 20224084, '计算机网络', 0, 4, 86, '2024-10-27');
INSERT INTO `score` VALUES (159, 20230001, 20224001, '计算机网络', 0, 14, 86, '2025-11-11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20081007 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '教师信息表' ROW_FORMAT = DYNAMIC;
